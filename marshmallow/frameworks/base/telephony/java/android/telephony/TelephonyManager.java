...
public class TelephonyManager {
	...
	try {
		mContext.checkPrivilegeEscalation(Binder.getCallingUid(), Monitor.IMEI_UID, System.currentTimeMillis(), "android.permission.READ_PHONE_STATE");
	}
	...
	// #                     Hook on getting IMEI begins                #
	// ##################################################################
	Log.i("LogicDroid", "Telephony manager getDeviceid IMEI called by the process UID: " + Binder.getCallingUid() );
	try {
		mContext.checkPrivilegeEscalation(Binder.getCallingUid(), Monitor.IMEI_UID, System.currentTimeMillis(), "android.permission.READ_PHONE_STATE");
	}
	catch (PrivilegeEscalationException pe) {
