...
public class PhoneSubInfo {
	...
	// ##################################################################
	Log.i("LogicDroid", "getDeviceid IMEI called by the process UID: " + Binder.getCallingUid() );
	try {
		mPhone.getContext().checkPrivilegeEscalation(Binder.getCallingUid(), Monitor.IMEI_UID, System.currentTimeMillis(), "android.permission.READ_PHONE_STATE");
	}
	...
	// #                     Hook on getting IMEI begins                #
	// ##################################################################
	Log.i("LogicDroid", "getIMEI IMEI called by the process UID: " + Binder.getCallingUid() );
	try {
		mPhone.getContext().checkPrivilegeEscalation(Binder.getCallingUid(), Monitor.IMEI_UID, System.currentTimeMillis(), "android.permission.READ_PHONE_STATE");
	}
	catch (PrivilegeEscalationException pe) {
	...
	Log.i("LogicDroid", "getnai called by the process UID: ");
	...
	Log.i("LogicDroid", "getdevicesvn called by the process UID: ");
	...
	// #                     Hook on getting IMEI begins                #
	// ##################################################################
	Log.i("LogicDroid", "getsubscriberid IMEI called by the process UID: " + Binder.getCallingUid() );
	try {
		mPhone.getContext().checkPrivilegeEscalation(Binder.getCallingUid(), Monitor.IMEI_UID, System.currentTimeMillis(), "android.permission.READ_PHONE_STATE");
	}
	catch (PrivilegeEscalationException pe) {
	...
	Log.i("LogicDroid", "getgroupidlevel1 IMEI called by the process UID: " + Binder.getCallingUid() );
	...
	Log.i("LogicDroid", "geticcserialnumber IMEI called by the process UID: " + Binder.getCallingUid() );
	...
	Log.i("LogicDroid", "getline1alphatag IMEI called by the process UID: " + Binder.getCallingUid() );
	...
	Log.i("LogicDroid", "getmsisdn IMEI called by the process UID: " + Binder.getCallingUid() );
